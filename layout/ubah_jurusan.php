    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="/laboran/app/proses.php" method="post">
                ...
                <input type="hidden" class="form-control" name="nama_jurusan" value="<?= $item['nama_jurusan'] ?>">
                <input type="text" class="form-control" name="nama_jurusan" value="<?= $item['nama_jurusan'] ?>">
        </div>
        <div class="form-group">
            <button type="submit" name="ubah_jurusan" class="btn btn-primary btn-sm">Ubah</button>
        </div>
        </form>
    </div>
</div>
